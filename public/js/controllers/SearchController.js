angular.module('SearchController', ['CourseService','AppUserService']).controller('SearchController', function($scope,$state,$mdDialog,$mdToast,$stateParams,CourseService,AppUserService) {



$scope.allCourses=[];

var searchParams=$stateParams.searchParams;
//console.log(searchParams);
if(searchParams.input==""){
  searchParams.input=null;
}
var promise = CourseService.searchCourses(searchParams);
        //console.log(promise);
        promise.then(
          function(payload) {
